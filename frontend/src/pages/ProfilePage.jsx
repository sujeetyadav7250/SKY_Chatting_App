...
const ProfilePage = () => {
  ...
  return (
    <div className="h-screen pt-20">
      <div className="max-w-2xl mx-auto p-4 py-4 sm:py-8">
        <div className="bg-base-300 rounded-xl p-4 sm:p-6 space-y-6 sm:space-y-8">
          ...
          <div className="mt-6 bg-base-300 rounded-xl p-4 sm:p-6">
            <h2 className="text-base sm:text-lg font-medium mb-4">Account Information</h2>
            <div className="space-y-3 text-sm">
              <div className="flex items-center justify-between py-2 border-b border-zinc-700">
                <span>Member Since</span>
                <span className="text-xs sm:text-sm">{authUser.createdAt?.split("T")[0]}</span>
              </div>
              <div className="flex items-center justify-between py-2">
                <span>Account Status</span>
                <span className="text-green-500 text-xs sm:text-sm">Active</span>
              </div>
            </div>
          </div>
        </div>
